...
extension Difficulty {
    ...
    /**
     Mixes the palette colors randomly to obtain a goal color that the user has to reach during the game.
     - parameters:
     ...
     - returns:
        - An array of RYB colors that contains in the first 9 positions the original color palette passed as parameter, followed by every color selected during the mixing process ordered chronologically. Use this second part of the array to help the user choosing the right combinations after an arbitrary amount of inactivity time during the game.
